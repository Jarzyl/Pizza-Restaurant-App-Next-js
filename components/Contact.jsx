...
function Contact() {
  return (
    <section className='w-full pt-14 pb-4 text-white' id='contact'>
    <div className='text-3xl md:text-6xl text-white text-center bg-red-500'>Contact</div>
    ...
    <div className='w-full text-xl md:text-2xl text-center mt-3'>
    ...
    <div className='w-full text-xl md:text-2xl text-center mb-10 mt-3'>
