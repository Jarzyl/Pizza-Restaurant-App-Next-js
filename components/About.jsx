...
function About() {
  return (
    <section className='w-full xl:h-screen 2xl:h-screen flex items-center mt-2' id='about'>
      ...
      <div className='justify-self-center text-center mt-5 pt-5 text-white'>
        ...
        <p className='text-sm md:text-xl xl:text-2xl 2xl:text-2xl ml-10 mr-10 md:mt-10'>At [Pizza Site], we're passionate about creating delicious, high-quality pizzas that bring people together. Our team of skilled chefs and friendly staff are dedicated to providing our customers with a memorable dining experience. We use only the freshest ingredients and authentic recipes to ensure that every bite of our pizza is bursting with flavor. Come visit us today and discover why we're the go-to destination for pizza lovers.</p>
